...
{
	//Code from MR.Gesture
	//http://github.com/MichaelRumpler/GestureSample/blob/master/GestureSample/GestureSample/ViewModels/TextOnlyViewModel.cs

	public class TextOnlyViewModel : ObservableViewModel
	{
