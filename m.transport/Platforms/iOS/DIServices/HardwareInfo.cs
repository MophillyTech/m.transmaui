...
//						width = Convert.ToInt32(UIScreen.MainScreen.Bounds.Width);
//					});
//				} catch (Exception ex) {
...
//				try {
//					Device.BeginInvokeOnMainThread( () => {
//						height = Convert.ToInt32(UIScreen.MainScreen.Bounds.Height);
//					});
//				} catch (Exception ex) {
//					Console.WriteLine (ex.Message);					
//				}
	...
	public string Model {
			get {
				...
				sysctlbyname (HardwareInfo.HardwareProperty, IntPtr.Zero, pLen, IntPtr.Zero, 0);
				...
				sysctlbyname (HardwareInfo.HardwareProperty, pStr, pLen, IntPtr.Zero, 0);
				...
				return GetModel (hardwareStr);
			}
		}

		// https://github.com/dannycabrera/Get-iOS-Model/blob/master/iOSHardware.cs
		private String GetModel(String hardware)
		{
...
//		public void SetDeliveryLocationTimer()
//        {
...
//#if DEBUG
//				AppDelegate.NextDateTime = DateTime.Now.AddSeconds(60);
//#else
//				AppDelegate.NextDateTime = DateTime.Now.AddMinutes(5);
//#endif
//			}
//			else
//			{
...
//				{
//					//transport.LocationManager.Instance.ReportDeliveryLocation();
//					return false;
//				});
//			}
//		}
