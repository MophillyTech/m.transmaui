...
{
	public static class VehicleExtensionsV2
	{
		public static void SetVehicleStatus(this DatsVehicleV5 v, VehicleStatus status)
		{
		...
		public static void MapVehicleStatusToLegStatus(this DatsVehicleV5 v, VehicleStatus status)
		{
		...
		public static VehicleStatus FixStatusEnum(this DatsVehicleV5 vehicle)
		{
			...
			if (vehicle.LegStatus == "Assigned"|| vehicle.LegStatus == "Scheduled & Assigned"|| vehicle.LegStatus == "Sched. & Assn.")
			{
				vehicle.SetVehicleStatus(VehicleStatus.Assigned);
			}
		...
		public static string GetStatusString(this DatsVehicleV5 vehicle)
		{
		...
		public static string GetVStatusString(this DatsVehicleV5 vehicle)
		{
